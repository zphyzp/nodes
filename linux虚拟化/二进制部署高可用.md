...
--cluster-cidr=169.168.0.0/16 "        #容器IP范围
...
spec:
  selector:
    k8s-app: kube-dns
  clusterIP: 169.169.0.222			#根据你的cluster ip范围填写
  ports:
  - name: dns
    port: 53
    protocol: UDP
...
Sep 13 10:45:07 k8s-node03 kubelet[19568]: /workspace/anago-v1.19.0-rc.4.197+594f888e19d8da/src/k8s.io/kubernetes/_output/do...t.go:90
Sep 13 10:45:07 k8s-node03 kubelet[19568]: k8s.io/kubernetes/vendor/k8s.io/apimachinery/pkg/util/wait.Forever(0xc000582e40, ...05f200)
Sep 13 10:45:07 k8s-node03 kubelet[19568]: /workspace/anago-v1.19.0-rc.4.197+594f888e19d8da/src/k8s.io/kubernetes/_output/do...1 +0x4f
Sep 13 10:45:07 k8s-node03 kubelet[19568]: created by k8s.io/kubernetes/pkg/kubelet/dockershim/network/cni.(*cniNetworkPlugin).Init
Sep 13 10:45:07 k8s-node03 kubelet[19568]: /workspace/anago-v1.19.0-rc.4.197+594f888e19d8da/src/k8s.io/kubernetes/_output/do... +0x117
Sep 13 10:45:08 k8s-node03 systemd[1]: kubelet.service holdoff time over, scheduling restart.
Sep 13 10:45:08 k8s-node03 systemd[1]: start request repeated too quickly for kubelet.service
Sep 13 10:45:08 k8s-node03 systemd[1]: Failed to start Kubernetes Kubelet Server.
Sep 13 10:45:08 k8s-node03 systemd[1]: Unit kubelet.service entered failed state.
Sep 13 10:45:08 k8s-node03 systemd[1]: kubelet.service failed.
